<?php
require_once("classes/student_reg_class.php");
                        ...
                        <div class="col-md-6"> 
                                ...
                                <div class="form-group">
                                    ...
                                    <label for="login_input_prn" >*PRN</label>
                                        ...
                                        <input type="text" class="form-control" placeholder="PRN" id="login_input_prn" name="prn" required />
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <label for="adyear" >*Admission Year</label>
                                        ...
                                        <div class="input-group date" id="adyear">
                <input type="text" class="form-control" name="adyear" />
